...
model_path = 'Drowsiness.keras'  # Update this with the correct model file path
...
def predict():
    ...
    output = 1 if prediction[0] >= 0.5 else 0  # Binary classification threshold at 0.5

    labels = ['DROWSY', 'NATURAL']  # Use your model's labels
